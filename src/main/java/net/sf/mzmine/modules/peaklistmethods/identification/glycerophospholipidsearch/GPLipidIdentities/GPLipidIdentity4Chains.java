...
public class GPLipidIdentity4Chains  extends SimplePeakIdentity {

    private final double mass;

    public GPLipidIdentity4Chains(final GPLipidType lipidType,
	    ...
	    final int fattyAcid4Length, final int fattyAcid4DoubleBonds) {
	...
	this(lipidType.getAbbr() + '(' + fattyAcid1Length + ':'
		...
		+ fattyAcid4DoubleBonds + ')', lipidType.getFormula()
    ...
    private GPLipidIdentity4Chains(final String name, final String formula) {
	...
	return new GPLipidIdentity4Chains(getName(),
